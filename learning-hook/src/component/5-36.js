...
export default function({ id, name, age, date }) {
	...
	return (
		<div>
			<div>
				<h1> 설명 </h1>
				<p> # 코드 5-36 componentDidUpdate 메서드를 훅으로 변환하기</p>
				<p> > userIdd가 변경된 경우 name 상탯값을 새로운 사용자 이름으로 변경</p>
				<p> </p>
				<p> * POINT1. userPrevious 훅을 이용해서 이전 userId를 저장</p>
				<p> * POINT2. 마운트 여부를 useRef훅으로 관리</p>
				<p> * POINT3. userIdd가 변경된 경우 name 상탯값을 새로운 사용자 이름으로 변경 </p>
			</div>
			<hr />
			<div>
				<h1> 예제 </h1>
