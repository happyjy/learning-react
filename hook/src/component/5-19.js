...
/*
  ...
  * useContext 훅을 이용하면 Consumer 컴포넌트를 사용하지 않고도 부모 컴포넌트로부터 전달된 코텍스트 데이터를 사용할 수 있다.
          ...
          <>
            <div>
              <div>
                ...
                <p></p>
                <p>
                  * useContext 훅을 이용하면 Consumer 컴포넌트를 사용하지 않고도
                  부모 컴포넌트로부터 전달된 코텍스트 데이터를 사용할 수 있다.
                </p>
                <p></p>
                <p>* 아래 예제 설명 !</p>
                <p>
                ...
                <p>
                  {" "}
                  - POINT1. 부모 컴포넌트에서 Provider 컴포넌트를 통해서
                  데이터를 전달
                </p>
                <p>
                  {" "}
                  - POINT2. 자식 컴포넌트에서는 Consumer 컴포넌트를 통해서
                  데이터를 사용
                </p>
                <p> - 한계!</p>
                <p>
                  {" "}
                  => 이 방식은 Consumer 컴포넌트 안족에서만 콘텍스트 데이터에
                  접근할 수 있다.
                </p>
                <p>
                  {" "}
                  - POINT3. 기존에는 POINT3 영역에서 콘텍스트 데이터를 사용하기
                  위해 콘텍스트 데이터를 전달해 주는 고차 컴포넌트를 사용했었다.
                </p>
                <p></p>
                <p>* 코드 5-20에서 다룰 것!</p>
                <p>
                  {" "}
                  - ⭐️ 'useContext' 훅을 사용해 POINT3영역에서도 콘텍스트
                  데이터에 접근 할 수 있다.
                </p>
              </div>
              <hr></hr>
