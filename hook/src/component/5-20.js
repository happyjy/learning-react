...
function ChildComponent() {
  ...
  console.log(
    "### useContext를 통해서 return 영역이 아닌 function영역에서 conext에 접근가능!",
  );
  return (
    <div>
          ...
          <>
            <div>
              <div>
                ...
                <p>
                  * ⭐️ useContext를 사용하면 코드5-19 POINT3 영역(useContext를
                  통해서 return 영역이 아닌 function영역에서 conext에
                  접근가능!)도 콘텍스트 데이터에 접근할 수 있다.
                </p>
              </div>
              <hr></hr>
              <div>
